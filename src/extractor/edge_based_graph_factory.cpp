             ...
             util::irange(0u, m_node_based_graph->GetNumberOfNodes()))
        {
                 ...
                 m_node_based_graph->GetAdjacentEdgeRange(node_at_center_of_intersection))
            {
                ...
                for (const auto &turn : intersection)
                {
                    ...
                    ExtractionTurn extracted_turn(turn, m_traffic_lights.count(node_at_center_of_intersection));
                    ...
                    auto duration_penalty = boost::numeric_cast<TurnPenalty>(extracted_turn.duration);
